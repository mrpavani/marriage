...
<head>
    ...
    <style>
        ...
        .tab.active { border-bottom-color: #d4af37; font-weight: bold; }
        ...
        input[type="text"], input[type="datetime-local"] { width: 100%; padding: 0.5rem; border: 1px solid #ddd; border-radius: 4px; }
        ...
        .delete-btn { position: absolute; top: 5px; right: 5px; background: red; color: white; border: none; padding: 2px 6px; cursor: pointer; border-radius: 4px; }
    </style>
</head>
<body>
            ...
            <div class="card">
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="wedding_date" value="<?= htmlspecialchars($settings['wedding_date'] ?? '') ?>" placeholder="YYYY-MM-DD HH:MM:SS">
                    </div>
                    <div class="form-group">
                        <label>Address</label>
                        <input type="text" name="wedding_address" value="<?= htmlspecialchars($settings['wedding_address'] ?? '') ?>">
                    </div>
                    <div class="form-group">
                        <label>PIX Key</label>
            ...
            <div class="photo-grid">
                <?php foreach ($photos as $photo): ?>
                    <div class="photo-item">
                        ...
                        <a href="?delete_photo=<?= $photo['id'] ?>" class="delete-btn" onclick="return confirm('Are you sure?')">X</a>
                    </div>
                <?php endforeach; ?>
            </div>
        </div>
